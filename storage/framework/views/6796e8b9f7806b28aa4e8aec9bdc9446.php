                                            ...
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="<?php echo e(url('detail/' . $specialProduct['id'])); ?>">Floral
                                                                Print
                                                                Shirt</a></h3>
                                                        <div class="product-price"> <span class="price">
                ...
                <div class="sidebar-widget product-tag wow fadeInUp">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="tag-list"> <a class="item" title="Phone" href="<?php echo e(url('category')); ?>">Phone</a>
                            <a class="item active" title="Vest" href="<?php echo e(url('category')); ?>">Vest</a> <a class="item" title="Smartphone" href="<?php echo e(url('category')); ?>">Smartphone</a> <a class="item" title="Furniture" href="<?php echo e(url('category')); ?>">Furniture</a> <a class="item" title="T-shirt" href="<?php echo e(url('category')); ?>">T-shirt</a> <a class="item" title="Sweatpants" href="<?php echo e(url('category')); ?>">Sweatpants</a> <a class="item" title="Sneaker" href="<?php echo e(url('category')); ?>">Sneaker</a> <a class="item" title="Toys" href="<?php echo e(url('category')); ?>">Toys</a> <a class="item" title="Rose" href="<?php echo e(url('category')); ?>">Rose</a>
                        </div>
                        <!-- /.tag-list -->
                    </div>
                    <!-- /.sidebar-widget-body -->
                                        ...
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="<?php echo e(url('detail/' . $newProduct['id'])); ?>"><?php echo e($newProduct['name']); ?></a>
                                                    </h3>
                                                    ...
                                                    <div class="action">
                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li class="add-cart-button btn-group">
                                                                <button data-toggle="tooltip" class="btn btn-primary icon cooke" data-id="<?php echo e($newProduct['id']); ?>" type="button" title="Add Cart">
                                ...
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p5.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p6.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p7.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p8.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p9.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p10.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                ...
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p11.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p12.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p13.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p14.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p15.jpg')); ?>" alt="image"></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p16.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                ...
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p18.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="<?php echo e(url('detail')); ?>"><img src="<?php echo e(asset('app\images\products\p17.jpg')); ?>" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="<?php echo e(url('detail/' . $newProduct['id'])); ?>"><?php echo e($item['name']); ?></a>
                                        </h3>
                                        <div class="description"><?php echo $item['description']; ?></div>
                                        <div class="product-price"> <span class="price"> <?php echo e($item['price']); ?>vnd
                                            </span>
                                        </div>
                                        <!-- /.product-price -->
                                                ...
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="<?php echo e(url('/detail/' . $product->id)); ?>">
                                                                <img src="<?php echo e(asset('app/images/products/' . $product->image_name)); ?>" alt=""> </a> </div>
                                                        <!-- /.image -->
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="<?php echo e(url('detail')); ?>">quod</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="<?php echo e(url('detail')); ?>">quen</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="<?php echo e(url('detail')); ?>">bambo</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="<?php echo e(url('detail')); ?>">oqin</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
                ...
                <div class="item item-carousel">
                    <div class="products">
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="<?php echo e(url('detail')); ?>"> 
                                        Buttoned</a></h3>
                                <div class="rating rateit-small"></div>
                                <div class="description"></div>
