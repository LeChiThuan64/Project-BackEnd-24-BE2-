...
<body>
    ...
    <div class="container">
        <div class="form-container sign-in-container">
            ...
            <form action="<?php echo e(url('change-password')); ?>" method="post" onsubmit="return validatePasswordMatch()">
                <?php echo csrf_field(); ?>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-right">
                    ...
                    <a href="<?php echo e(url('login')); ?>" class="hehe" style="color: white;">Quay lại đăng nhập</a>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH D:\Tài liệu Môn Học\Kì 4\BE2\Git\nhom3_ST5_BE2_NH23-24\resources\views/auth/passwordVerification.blade.php ENDPATH**/ ?>