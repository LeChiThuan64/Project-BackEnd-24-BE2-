...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('app\css\myAccount.css') }}">
</head>
    ...
    <div class="container rounded bg-white mt-5">
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="{{ asset('app\AnhUsr\user.png') }}" width="90">
            ...
            <div class="col-md-8">
                <form action="{{ route('user.update') }}" method="post">
                    @csrf
                    @method('PUT') <!-- Đây là cú pháp của Laravel để giả mạo phương thức PUT nếu bạn đang sử dụng RESTful controller -->
                    <div class="p-3 py-5">
