            ...
            <div class='col-md-9'>
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            <button data-toggle="dropdown" type="button" class="btn dropdown-toggle" id="dropdownMenuButton">
                                                <?php echo e(ucfirst(str_replace('_', ' ', $sortType))); ?> <span class="caret"></span>
                                            </button>
                                    ...
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            <button data-toggle="dropdown" type="button" class="btn dropdown-toggle" id="showDropdownButton">
                                                <?php echo e($showCount); ?> <span class="caret"></span>
                                            </button>
                                            <ul role="menu" class="dropdown-menu" id="showDropdownMenu">
                                                <?php for($i = 1; $i <= 6; $i++): ?> <li role="presentation"><a class="dropdown-item" href="#" data-show="<?php echo e($i); ?>"><?php echo e($i); ?></a></li>
                                                    <?php endfor; ?>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="clearfix filters-container">
                    ...
                    <div class="row" style="margin-left: 660px;">
                            <?php echo e($products->appends(['sort' => $sortType, 'show' => $showCount])->links('vendor.pagination.default')); ?>
