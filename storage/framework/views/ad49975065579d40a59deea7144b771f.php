                ...
                <div class='col-md-3 sidebar'>
                    ...
                    <div class="sidebar-module-container">
                        <div class="sidebar-filter">
                            ...
                            <!-- ============================================== PRICE SILDER============================================== -->
                            <form id="price-filter-form" method="GET" action="<?php echo e(route('filterProducts')); ?>"
                                            ...
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li role="presentation"><a class="dropdown-item"
                                                            href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'position'])); ?>">Position</a>
                                                    </li>
                                                    <li role="presentation"><a class="dropdown-item"
                                                            href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'price_asc'])); ?>">Price:
                                                            Lowest first</a></li>
                                                    <li role="presentation"><a class="dropdown-item"
                                                            href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'price_desc'])); ?>">Price:
                                                            Highest first</a></li>
                                                    <li role="presentation"><a class="dropdown-item"
                                                            href="<?php echo e(route('category', ['categoryId' => $category->id, 'sort' => 'name_asc'])); ?>">Product
                                                            Name: A to Z</a></li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div id="myTabContent" class="tab-content category-list">
                            <div class="tab-pane active " id="grid-container">
                                ...
                                <div class="product-info text-left">
                                    <h3 class="name"><a
                                            href="<?php echo e(url('detail/' . $product->id)); ?>"><?php echo e($product->name); ?>
